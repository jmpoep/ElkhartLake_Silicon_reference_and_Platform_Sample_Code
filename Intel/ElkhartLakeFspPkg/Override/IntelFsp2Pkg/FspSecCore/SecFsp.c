...
#if (FixedPcdGetBool(PcdBfxEnable) == 1)
//
// FSPO-0012: RoyalParkOverrideBegin
//
  // Use FspMode to represent ApiMode/DispatchMode variable
  // FspMode = 0, means ApiMode enabled
  // FspMode = 1, means DispatchMode enabled
  // PeiFspData->FspMode         = FSP_IN_API_MODE;
//
// FSPO-0012: RoyalParkOverrideEnd
//
#endif
