    ...
    try:
        ...
        if os.path.isfile(BuildConfigurationFile) == True:
            ...
            if not GenFdsGlobalVariable.TargetName:
                BuildTargetList = TargetTxt.TargetTxtDictionary[TAB_TAT_DEFINES_TARGET] # CCEO-0013: RoyalParkOverrideContent
            ...
            if not GenFdsGlobalVariable.ToolChainTag:
                ToolChainList = TargetTxt.TargetTxtDictionary[TAB_TAT_DEFINES_TOOL_CHAIN_TAG] # CCEO-0013: RoyalParkOverrideContent
        ...
        BuildWorkSpace = WorkspaceDatabase()  # CCEO-0018: RoyalParkOverrideContent
        #
