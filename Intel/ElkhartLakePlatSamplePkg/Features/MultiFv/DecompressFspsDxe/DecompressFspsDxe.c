/** @file
  Driver for Decompressing FSPS when FSP Wrapper is enabled.
  ...
  )
{
  ...
  if (BootState == NULL) {
    DEBUG((DEBUG_INFO, "[FSPS] FSPS will be processed by SpiFvbService driver\n"));
    return EFI_SUCCESS;
  }
