...
#define MRC_SENSAMP_OFFSET_CORR         (0xDD64)
#define MRC_SENSAMP_OFFSET_CORR_ERROR   (MRC_SENSAMP_OFFSET_CORR | MRC_FAILURE_INDICATION)

#define MRC_DCC_REPLICA                 (0xDD65)
#define MRC_DCC_REPLICA_ERROR           (MRC_DCC_REPLICA | MRC_FAILURE_INDICATION)

#define MRC_DCC_FINAL                   (0xDD66)
...
#define MRC_CMD_SR                      (0xDD6A)
#define MRC_CMD_SR_ERROR                (MRC_CMD_SR | MRC_FAILURE_INDICATION)

#define MRC_CMD_SR_OFF                  (0xDD6B)
#define MRC_CMD_SR_OFF_ERROR            (MRC_CMD_SR_OFF | MRC_FAILURE_INDICATION)

#define MRC_CMD_DS                      (0xDD6C)
#define MRC_CMD_DS_ERROR                (MRC_CMD_DS     | MRC_FAILURE_INDICATION)

#define MRC_DIMM_ODT_CA                 (0xDD6D)
#define MRC_DIMM_ODT_CA_ERROR           (MRC_DIMM_ODT_CA | MRC_FAILURE_INDICATION)

#define MRC_TXTCO_DQS_TRAINING          (0xDD6E)
#define MRC_TXTCO_DQS_TRAINING_ERROR    (MRC_TXTCO_DQS_TRAINING | MRC_FAILURE_INDICATION)

#define MRC_DQ_DFE_TRAINING             (0xDD6F)
#define MRC_DQ_DFE_TRAINING_ERROR       (MRC_DQ_DFE_TRAINING | MRC_FAILURE_INDICATION)
...
#define MRC_MARGIN_LIMIT_CHECK          (0xDD73)
#define MRC_MARGIN_LIMIT_CHECK_ERROR    (MRC_MARGIN_LIMIT_CHECK | MRC_FAILURE_INDICATION)

#define MRC_EARLY_CMDVC                 (0xDD74)
#define MRC_EARLY_CMDVC_ERROR           (MRC_EARLY_CMDVC | MRC_FAILURE_INDICATION)

#define MRC_IBECC                       (0xDD75)
#define MRC_IBECC_ERROR                 (MRC_IBECC | MRC_FAILURE_INDICATION)
