...
GLOBAL_REMOVE_IF_UNREFERENCED GPIO_PAD mPchLpGpioStandbyStateMaskedPads[] =
{
  ...
  GPIO_VER2_LP_PRDYB,
  GPIO_VER2_LP_PREQB,
  GPIO_VER2_LP_CPU_TRSTB,
  GPIO_VER2_LP_TRIGGER_IN,
  GPIO_VER2_LP_TRIGGER_OUT
};

GLOBAL_REMOVE_IF_UNREFERENCED GPIO_PAD mPchHGpioStandbyStateMaskedPads[] =
{
  GPIO_VER2_H_JTAGX,
  GPIO_VER2_H_PRDYB,
  GPIO_VER2_H_PREQB,
  GPIO_VER2_H_CPU_TRSTB,
  GPIO_VER2_H_TRIGGER_IN,
  GPIO_VER2_H_TRIGGER_OUT
};
  ...
  )
{
  if (IsPchLp ()) {
    ...
    *GpioPadsList = mPchHGpioStandbyStateMaskedPads;
    return ARRAY_SIZE (mPchHGpioStandbyStateMaskedPads);
  }
}
