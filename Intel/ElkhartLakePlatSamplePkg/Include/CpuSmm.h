...
VERIFY_OFFSET (CPU_SMM, CpuSmmUseDelayIndication, 0x1);
VERIFY_OFFSET (CPU_SMM, CpuSmmUseBlockIndication, 0x2);
VERIFY_OFFSET (CPU_SMM, CpuSmmUseSmmEnableIndication, 0x3);
VERIFY_OFFSET (CPU_SMM, CpuSmmProcTraceEnable, 0x4);
