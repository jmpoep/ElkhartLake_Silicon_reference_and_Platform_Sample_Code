...
#define GPIO_VER2_H_MUXING_SERIALIO_UART0_RXD_GPP_C9         (GPIO_NATIVE_PAD_DEF (GPIO_VER2_H_GPP_C9,  1, GPIO_FUNCTION_SERIAL_IO_UART_TX(0)))
#define GPIO_VER2_H_MUXING_SERIALIO_UART0_RXD_GPP_J4         (GPIO_NATIVE_PAD_DEF (GPIO_VER2_H_GPP_J4,  2, GPIO_FUNCTION_SERIAL_IO_UART_TX(0)))
#define GPIO_VER2_H_MUXING_SERIALIO_UART0_RXD_GPP_C10        (GPIO_NATIVE_PAD_DEF (GPIO_VER2_H_GPP_C10, 1, GPIO_FUNCTION_SERIAL_IO_UART_RTS(0)))
#define GPIO_VER2_H_MUXING_SERIALIO_UART0_RXD_GPP_J2         (GPIO_NATIVE_PAD_DEF (GPIO_VER2_H_GPP_J2,  2, GPIO_FUNCTION_SERIAL_IO_UART_RTS(0)))
#define GPIO_VER2_H_MUXING_SERIALIO_UART0_RXD_GPP_C11        (GPIO_NATIVE_PAD_DEF (GPIO_VER2_H_GPP_C11, 1, GPIO_FUNCTION_SERIAL_IO_UART_CTS(0)))
#define GPIO_VER2_H_MUXING_SERIALIO_UART0_RXD_GPP_J5         (GPIO_NATIVE_PAD_DEF (GPIO_VER2_H_GPP_J5,  2, GPIO_FUNCTION_SERIAL_IO_UART_CTS(0)))
