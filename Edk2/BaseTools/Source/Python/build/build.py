...
from Workspace.WorkspaceDatabase import WorkspaceDatabase          # CCEO-0018: RoyalParkOverrideContent
...
class Build():
    ...
    def __init__(self, Target, WorkspaceDir, BuildOptions):
        ...
        self.Db = WorkspaceDatabase()                          # CCEO-0018: RoyalParkOverrideContent
...
#            self.Db.InitDatabase()                   # CCEO-0018: RoyalParkOverrideContent
            self.Db_Flag = True
...
#            self.Db.Close()                                 # CCEO-0018: RoyalParkOverrideContent
...
#        MyBuild.Db.Close()         # CCEO-0018: RoyalParkOverrideContent
    EdkLogger.SetLevel(EdkLogger.QUIET)
    EdkLogger.quiet("\n- %s -" % Conclusion)
