  ...
  )
{
  ...
  SerialIoUartSetAttributes (2, BaudRate, Parity, DataBits, StopBits, FALSE);
...
{
  return SerialIoUartSetControl (2, Control);
}
...
{
  return SerialIoUartGetControl (2, Control);
}
  ...
  )
{
  ...
  Count = SerialIoUartWrite (2, Buffer, *BufferSize);
  ...
  )
{
  ...
  if (SerialIoUartPolling (2)) {
    Count = SerialIoUartRead (2, Buffer, *BufferSize, FALSE);
  }
