...
**/
#ifndef _PEI_GRAPHICS_POLICY_LIB_H_
#define _PEI_GRAPHICS_POLICY_LIB_H_

#include <Ppi/SiPolicy.h>
#include <Library/ConfigBlockLib.h>

/**
  This function prints the PEI phase PreMem Graphics policy.
...
/**
  This function prints the PEI phase Graphics policy.
...
/**
  Get Graphics PEI PreMem config block table total size.

  @retval      Size of Graphics PEI PreMem config block table
**/
UINT16
EFIAPI
...
/**
  This function is used to add Graphics PEI PreMem Config Block.
...
/**
  This function is used to add Graphics PEI Config Block.
...
#endif // _PEI_GRAPHICS_POLICY_LIBRARY_H_
