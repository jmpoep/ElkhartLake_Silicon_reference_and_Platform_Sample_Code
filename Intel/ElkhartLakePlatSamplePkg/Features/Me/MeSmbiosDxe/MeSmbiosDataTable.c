...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_MISC_SUBCLASS_DATA_TABLE  mMiscSubclassDataTable[] = {
  ...
  MISC_SUBCLASS_TABLE_ENTRY_DATA_AND_FUNCTION(MISC_OEM_TYPE_0x82, MiscOemType0x82, MiscOemType0x82),
#endif
  MISC_SUBCLASS_TABLE_ENTRY_DATA_AND_FUNCTION(MISC_OEM_TYPE_0x83, MiscOemType0x83, MiscOemType0x83)
};
