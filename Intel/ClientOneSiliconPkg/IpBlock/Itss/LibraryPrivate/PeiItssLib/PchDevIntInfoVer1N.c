...
//
GLOBAL_REMOVE_IF_UNREFERENCED CONST PCH_DEV_INT_INFO mPchNDeviceInterruptInfo[] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED UINT32 mPchNDeviceInterruptInfoSize = ARRAY_SIZE (mPchNDeviceInterruptInfo);