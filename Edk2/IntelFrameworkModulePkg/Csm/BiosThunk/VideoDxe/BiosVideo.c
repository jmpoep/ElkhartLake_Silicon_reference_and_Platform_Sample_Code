  ...
  )
{
  ...
  //
  // CLIENT_EDK2_OVERRIDE: ClientEdk2OverrideBegin - CCEO-0001
  //
  //
  // BIOS W/A for VBIOS limitation above 8MB. Clear frame buffer before Set VBE Mode
  //
  gBS->SetMem ( ModeData->LinearFrameBuffer, ModeData->FrameBufferSize, 0);
  //
  // CLIENT_EDK2_OVERRIDE: ClientEdk2OverrideEnd - CCEO-0001
  //
