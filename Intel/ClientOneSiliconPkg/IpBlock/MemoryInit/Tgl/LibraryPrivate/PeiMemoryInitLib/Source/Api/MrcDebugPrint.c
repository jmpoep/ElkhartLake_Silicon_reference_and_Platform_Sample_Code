...
///
const char *gDdrTypeStr[MAX_MRC_DDR_TYPE]  = {"DDR4", "DDR5", "LPDDR5", "LPDDR4", "UNKNOWN"}; // Note: Must align to MrcDdrType
...
const char *gIoRxModeStr[]          = {"Matched N", "Matched P", "Unmatched w/ Rload DQS", "Unmatched w/ P-path", "Max"}; // Note: must match MRC_RX_MODE_TYPE values
const char *gIoOdtModeStr[]         = {"Default", "Vtt", "Vddq", "Vss", "Max"}; // Note: must match MRC_ODT_MODE_TYPE values
