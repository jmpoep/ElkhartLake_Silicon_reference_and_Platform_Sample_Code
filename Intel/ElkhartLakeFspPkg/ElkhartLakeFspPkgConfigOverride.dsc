## @file
#  FSP configuration override file.
#
# @copyright
#  INTEL CONFIDENTIAL
...
#
  #
  # Since PcdSimicsEnable has been removed and EHL run in Simics Environment currently,
  ...
  !if $(TARGET) == DEBUG
    gElkhartLakeFspPkgTokenSpaceGuid.PcdMonoStatusCode|TRUE
  !endif
