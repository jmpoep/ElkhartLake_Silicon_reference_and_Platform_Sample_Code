/** @file
  Serial IO Private Uart Lib implementation IceLake specific.
...
GLOBAL_REMOVE_IF_UNREFERENCED SERIAL_IO_BDF_NUMBERS mPchLpPchHSerialIoUartBdf [] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED UINT16 mPchLpSerialIoUartDevId [] = {
  V_VER1_PCH_LP_SERIAL_IO_CFG_UART0_DEVICE_ID,
  V_VER1_PCH_LP_SERIAL_IO_CFG_UART1_DEVICE_ID,
  V_VER1_PCH_LP_SERIAL_IO_CFG_UART2_DEVICE_ID
};

GLOBAL_REMOVE_IF_UNREFERENCED UINT16 mPchHSerialIoUartDevId [] = {
  V_VER1_PCH_H_SERIAL_IO_CFG_UART0_DEVICE_ID,
  V_VER1_PCH_H_SERIAL_IO_CFG_UART1_DEVICE_ID,
  V_VER1_PCH_H_SERIAL_IO_CFG_UART2_DEVICE_ID
};

GLOBAL_REMOVE_IF_UNREFERENCED UINT16 mPchNSerialIoUartDevId [] = {
  V_VER1_PCH_N_SERIAL_IO_CFG_UART0_DEVICE_ID,
  V_VER1_PCH_N_SERIAL_IO_CFG_UART1_DEVICE_ID,
  V_VER1_PCH_N_SERIAL_IO_CFG_UART2_DEVICE_ID
};

GLOBAL_REMOVE_IF_UNREFERENCED UINT16 mPchSerialIoUartPciCfgCtrAddr [] = {
  R_VER1_SERIAL_IO_PCR_PCICFGCTRL_UART0,
  R_VER1_SERIAL_IO_PCR_PCICFGCTRL_UART1,
  R_VER1_SERIAL_IO_PCR_PCICFGCTRL_UART2
};
...
{
  return mPchLpPchHSerialIoUartBdf[UartNumber].DevNum;
}
...
{
  return mPchLpPchHSerialIoUartBdf[UartNumber].FuncNum;
}
...
{
  if (IsPchN ()) {
    return mPchNSerialIoUartDevId[UartNumber];
  } else if (IsPchH ()) {
