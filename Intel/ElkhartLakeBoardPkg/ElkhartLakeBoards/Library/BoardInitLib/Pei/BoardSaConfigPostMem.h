...
#ifndef _BOARD_SA_CONFIG_POST_MEM_H_
#define _BOARD_SA_CONFIG_POST_MEM_H_
...
//
// Display DDI settings for EHL RVP1 ERB
//
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 mEhlRvp1ErbRowDisplayDdiConfig[17] = {
...
//
// Display DDI settings for EHL RVP2
//
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 mEhlRvp2RowDisplayDdiConfig[17] = {
                                                                               DdiPortAEdp,     // DDI Port A Config : DdiPortADisabled = Disabled, DdiPortAEdp = eDP, DdiPortAMipiDsi = MIPI DSI, DdiPortADp = Dp
                                                                               DdiPortBHdmi,    // DDI Port B Config : DdiPortBDisabled = Disable, DdiPortBDp = Dp, DdiPortBMipiDsi = MIPI DSI, DdiPortBHdmi = Hdmi
                                                                               DdiPortCDp,      // DDI Port C Config : DdiPortCDisabled = Disable, DdiPortCHdmi = Dp, DdiPortCDp = Dp
                                                                               DdiHpdDisable,   // DDI Port A HPD : DdiHpdDisable = Disable, DdiHpdEnable = Enable HPD
                                                                               DdiHpdEnable,    // DDI Port B HPD : DdiHpdDisable = Disable, DdiHpdEnable = Enable HPD
                                                                               DdiHpdEnable,    // DDI Port C HPD : DdiHpdDisable = Disable, DdiHpdEnable = Enable HPD
                                                                               DdiHpdDisable,   // DDI Port 1 HPD : DdiHpdDisable = Disable, DdiHpdEnable = Enable HPD
...
//
// Display DDI settings for JSL DDR4 SODIMM
//
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 mJslDdr4RowDisplayDdiConfig[13] = {
...
#endif // _BOARD_SA_CONFIG_POST_MEM_H_
