...
#define UFS_HC_UTRLRSR_OFFSET      0x0060  // UTP Transfer Request Run-Stop Register
  ...
  //
#define UFS_HC_UTRLCNR_OFFSET      0x0064  // UTP Transfer Request List Completion Notification Register
  //
...
#define UFS_HC_CAP_NUTMRS          (BIT16 | BIT17 | BIT18)
  ...
  // RPPO-LKF-0009: OverrideBegin
  //
#define UFS_HC_CAP_CS              BIT28
#define UFS_HC_CAP_UICDMETMS       BIT26
#define UFS_HC_CAP_OODDS           BIT25
#define UFS_HC_CAP_AUTOH8          BIT23
#define UFS_HC_CAP_NORTT           (BIT15 | BIT14 | BIT13| BIT12| BIT11| BIT10| BIT9| BIT8)
  //
  // RPPO-LKF-0009: OverrideEnd
  //
...
typedef struct {
  ...
  union {
    UINT32 Data32;
    struct {
      UINT32 GenSel:16;              /* Bit  0:15: GenSelectorIndex */
      UINT32 MIBAttrib:16;           /* Bit 16:31: MIBattribute */  
    } Fields;
  }	Arg1;
  //
  // Arg 2
  ...
  union {
     UINT32 Data32;
     struct {
        UINT32 ConfigResultCode:8;    /* Bit  0:07: ConfigResultCode */
        UINT32 Rsvd:8;                /* Bit 08:15: Reserved */  
        UINT32 AttrSetType:8;         /* Bit 16:23: AttrSetType */ 
        UINT32 Rsvd1:8;               /* Bit 24:31: Reserved */ 
     } Fields;
  } Arg2;  
  //
  // Arg 3
  //
  UINT32 MIBvalue;           /* Bit  0:31: MIBvalue */ 
} PHY_DME_DATA;
//
