...
!if gSiPkgTokenSpaceGuid.PcdEhlPchEnable == TRUE
  DEFINE PCH_BUILD_OPTIONS = -DPCH_EHL -DPCH_TGL -DPCH_ICL
!elseif gSiPkgTokenSpaceGuid.PcdIclPchEnable == TRUE
  DEFINE PCH_BUILD_OPTIONS = -DPCH_ICL
!else
...
!if gSiPkgTokenSpaceGuid.PcdBfxHfpgaWorkAroundEnable == TRUE
  DEFINE BIOS_BFX_BUILD_OPTIONS = -DHFPGA_FLAG
!else
  DEFINE BIOS_BFX_BUILD_OPTIONS =
!endif

  DEFINE CPU_FLAGS = -DCPU_ICL -DCPU_EHL
