...
{
  EFI_STATUS                                Status;
  BOOLEAN                                   ImageInPermanentMemory;  // RPPO-LKF-0013: RoyalParkOverrideContent
  EFI_PEI_PPI_DESCRIPTOR                    *OldDescriptor;          // RPPO-LKF-0013: RoyalParkOverrideContent
  VOID                                      *OldFtwPpi;              // RPPO-LKF-0013: RoyalParkOverrideContent
