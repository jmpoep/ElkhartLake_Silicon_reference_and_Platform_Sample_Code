  ...
  )
{
  ...
  PatchInstructionX86 (gPatchSmmCr4, mSmmCr4 & (~CR4_CET_ENABLE), 4); // CCEO-0016: RoyalParkOverrideContent
  ...
  )
{
  ...
  VOID                       *Registration;
  UINT32                     RegEax;
  UINT32                     RegEbx; // CCEO-0016: RoyalParkOverrideContent
  UINT32                     RegEcx; // CCEO-0016: RoyalParkOverrideContent
  UINT32                     RegEdx;
  UINTN                      FamilyId;
  UINTN                      ModelId;
  UINT32                     Cr3;
...
//
  ...
  //
  mSmmStackSize = EFI_PAGES_TO_SIZE (EFI_SIZE_TO_PAGES (PcdGet32 (PcdCpuSmmStackSize))); // CCEO-0016: RoyalParkOverrideContent
