...
{
  return CmosRead32 (PcdGet8 (PcdSerialBaudRateCmosIndex));
}
...
{
  CmosWrite32 (PcdGet8 (PcdSerialBaudRateCmosIndex), BaudRate);
  return TRUE;
}
...
{
  return CmosRead8 (PcdGet8 (PcdStatusCodeFlagsCmosIndex));
}
...
{
  CmosWrite8 (PcdGet8 (PcdStatusCodeFlagsCmosIndex), DebugInterface);
}
