/** @file
  eSPI library header for abstraction of eSPI HW registers accesses
...
#ifndef _ESPI_ACCESS_PRIVATE_LIB_H_
#define _ESPI_ACCESS_PRIVATE_LIB_H_
...
#endif // _ESPI_ACCESS_PRIVATE_LIB_H_
