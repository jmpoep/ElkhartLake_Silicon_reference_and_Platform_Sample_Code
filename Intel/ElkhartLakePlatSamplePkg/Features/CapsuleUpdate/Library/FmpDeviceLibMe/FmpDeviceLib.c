  ...
  )
{
  ...
  *Version = mMeBiosPayloadHob->MeBiosPayload.FwVersionName.BuildVersion;
  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "FmpDeviceSetImage (ME) - Start\n"));
  ...
  Status = UpdateMeFirmware ((UINT8 *)Image, ImageSize, Progress, 5, 95);
  ...
  DEBUG ((DEBUG_INFO, "FmpDeviceSetImage (ME) - %r\n", Status));
