## @file
# FmpDxe driver for SIIP FW update.
#
#@copyright
#  INTEL CONFIDENTIAL
...
##
  ...
  FmpDevicePkg/FmpDxe/FmpDxe.inf {
    <Defines>
      ...
      #
      FILE_GUID = $(FMP_CLIENT_PLATFORM_SYSTEM_SIIP_FW)
    <PcdsFixedAtBuild>
      #
      # Unicode name string that is used to populate FMP Image Descriptor for this capsule update module
      #
      gFmpDevicePkgTokenSpaceGuid.PcdFmpDeviceImageIdName|L"ElkhartLake SIIP FW Sub Region"
    ...
    <LibraryClasses>
      ...
      #
      FmpDeviceLib|$(PLATFORM_FEATURES_PATH)/CapsuleUpdate/Library/FmpDeviceLibSiipFw/FmpDeviceLibSiipFw.inf
