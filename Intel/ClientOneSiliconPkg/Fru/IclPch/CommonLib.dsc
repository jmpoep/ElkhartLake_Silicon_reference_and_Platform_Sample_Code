## @file
#  Component description file for the Icelake PCH Common FRU libraries.
#
# @copyright
#  INTEL CONFIDENTIAL
...
!else
  PchTraceHubLib|$(PLATFORM_SI_PACKAGE)/IpBlock/TraceHub/LibraryPrivate/BasePchTraceHubLibNull/BasePchTraceHubInitLibNull.inf
!endif
