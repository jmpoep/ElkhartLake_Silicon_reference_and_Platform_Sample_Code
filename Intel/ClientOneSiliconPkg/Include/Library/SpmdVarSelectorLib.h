/** @file
  Secure Pre-Memory Data Variable Storage Selector Library
...
**/
#ifndef _SECURE_PRE_MEMORY_DATA_VARIABLE_STORAGE_SELECTOR_LIB_H_
#define _SECURE_PRE_MEMORY_DATA_VARIABLE_STORAGE_SELECTOR_LIB_H_
