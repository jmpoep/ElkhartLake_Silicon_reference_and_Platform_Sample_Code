...
typedef enum {
  ...
  MF_GV_LOW   = (1 << 5), ///< Execute MRC function when in Low  SA GV point.
  MF_GV_MID   = (1 << 6), ///< Execute MRC function when in Mid  SA GV point.
  MF_GV_HIGH  = (1 << 7), ///< Execute MRC function when in High SA GV point.
