## @file
#  Component description file for the JasperLake SiPkg PEI libraries.
#
# @copyright
#  INTEL CONFIDENTIAL
...
# FRUs
#
!include $(PLATFORM_SI_PACKAGE)/Fru/JslCpu/PeiLib.dsc
...
!endif
 ItbtPcieRpInitLib|$(PLATFORM_SI_PACKAGE)/IpBlock/CpuPcieRp/LibraryPrivate/ItbtPcieRpInitLibNull/ItbtPcieRpInitLibNull.inf
...
# TO-DO: can be enabled after updating these libraries to latest policy configuations.
