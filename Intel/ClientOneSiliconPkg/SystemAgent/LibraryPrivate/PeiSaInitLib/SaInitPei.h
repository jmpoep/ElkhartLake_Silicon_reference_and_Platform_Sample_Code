...
**/
#ifndef _SA_INIT_PEI_H_
#define _SA_INIT_PEI_H_
...
/**
  The function update SA config hob in the end of SaInit.
...
/**
  The function update pch info hob in the end of SaInit.
**/
VOID
BuildSaInfoHob (
  VOID
