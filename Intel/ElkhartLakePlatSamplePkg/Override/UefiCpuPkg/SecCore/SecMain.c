...
#include "../../UefiCpuPkg/SecCore/SecMain.h"
  ...
  )
{
  ...
  EFI_PEI_PPI_DESCRIPTOR      *PpiListTmp; // RPPO-CNL-0090: RoyalParkOverrideContent
  UINT32                      Index;
  EFI_PEI_PPI_DESCRIPTOR      *AllSecPpiList;
  EFI_PEI_CORE_ENTRY_POINT    PeiCoreEntryPoint;

  PeiCoreEntryPoint = NULL;                // RPPO-CNL-0090: RoyalParkOverrideContent
  ...
  //
//
// RPPO-CNL-0090: RoyalParkOverrideBegin
//
...
//
// RPPO-CNL-0090: RoyalParkOverrideEnd
//
