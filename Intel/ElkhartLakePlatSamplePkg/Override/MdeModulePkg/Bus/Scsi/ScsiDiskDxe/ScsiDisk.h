...
#include <Protocol/StorageSecurityCommand.h> // RPPO-LKF-0019: RoyalParkOverrideContent
...
#define IS_ALIGNED(addr, size)    (((UINTN) (addr) & (size - 1)) == 0) // RPPO-LKF-0019: RoyalParkOverrideContent

#define UFS_WLUN_RPMB 0xC4 // RPPO-LKF-0019: RoyalParkOverrideContent
...
typedef struct {
  ...
  EFI_STORAGE_SECURITY_COMMAND_PROTOCOL   StorageSecurity; // RPPO-LKF-0019: RoyalParkOverrideContent
...
#define SCSI_DISK_DEV_FROM_STORSEC(a)  CR (a, SCSI_DISK_DEV, StorageSecurity, SCSI_DISK_DEV_SIGNATURE) // RPPO-LKF-0019: RoyalParkOverrideContent
...
//
// RPPO-LKF-0019: RoyalParkOverrideBegin
//
/**
...
//
// RPPO-LKF-0019: RoyalParkOverrideEnd
//
