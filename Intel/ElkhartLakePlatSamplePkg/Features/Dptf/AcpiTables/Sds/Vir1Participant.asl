...
Scope(\_SB)
{
  ...
  Device(VIR1)
  {
    ...
    Name (VSCT, Package()
    {
      ...
      Package()
      {
        Package () {\_SB.PC00.TCPU,9,0,30,1,30,0},
#ifdef EC_SUPPORT
        Package () {\_SB.PC00.LPCB.H_EC.SEN3,14,0,30,0,50,0}
#endif
#ifdef ECLITE_PSE_SUPPORT
        Package () {\_SB.SEN3,14,0,30,0,50,0}
    ...
    {
      If (LEqual(\V1AT,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
    ...
    {
      If (LEqual(\V1PV,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
    ...
    {
      If (LEqual(\V1CR,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
    ...
    {
      If (LEqual(\V1C3,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
    ...
    {
      If (LEqual(\V1HT,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
