...
class FfsInfStatement(FfsInfStatementClassObject):
    ...
    #
    def __InfParse__(self, Dict = None, IsGenFfs=False): # CCEO-0021: RoyalParkOverrideContent
    ...
    def GenFfs(self, Dict = {}, FvChildAddr = [], FvParentAddr=None, IsMakefile=False, FvName=None):
        ...
        self.__InfParse__(Dict, IsGenFfs=True) # CCEO-0021: RoyalParkOverrideContent
