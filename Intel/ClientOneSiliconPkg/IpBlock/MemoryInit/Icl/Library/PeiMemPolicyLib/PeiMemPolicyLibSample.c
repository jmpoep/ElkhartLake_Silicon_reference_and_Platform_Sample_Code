...
//
// DQ byte mapping to CMD/CTL/CLK, from the CPU side - for ICL MRC
//
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 mDqByteMapIcl[2][6][2] = {
  // Channel 0:
  {
    ...
    { 0x00, 0x00 }, // Unused in CNL/ICL MRC
    { 0x00, 0x00 }, // Unused in CNL/ICL MRC
    { 0x00, 0x00 }, // Unused in CNL/ICL MRC
  },
  // Channel 1:
...
//
// DQS byte swizzling between CPU and DRAM - Sample
//
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 mDqsMapCpu2DramSample[2][8] = {
  { 2, 0, 1, 3, 6, 4, 7, 5 }, // Channel 0
  { 1, 3, 2, 0, 5, 7, 6, 4 }  // Channel 1
};
  ...
  )
{
  ...
  MemCall->MrcDelayNs           = &SaDelayNs;
  CopyMem ((VOID *) MemConfigNoCrc->SpdData->SpdData[0][0], mLpddr4xDdp8Gb200bSpd, sizeof (mLpddr4xDdp8Gb200bSpd));
  CopyMem ((VOID *) MemConfigNoCrc->SpdData->SpdData[1][0], mLpddr4xDdp8Gb200bSpd, sizeof (mLpddr4xDdp8Gb200bSpd));
  CopyMem ((VOID *) MemConfigNoCrc->DqByteMap,  mDqByteMapIcl,          sizeof (mDqByteMapIcl));
  CopyMem ((VOID *) MemConfigNoCrc->DqsMap,     mDqsMapCpu2DramSample,  sizeof (mDqsMapCpu2DramSample));
}
