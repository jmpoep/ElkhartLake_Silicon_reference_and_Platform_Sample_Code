## @file
# FmpDxe driver for TCC Configuration update.
#
#@copyright
#  INTEL CONFIDENTIAL
...
##
  ...
  FmpDevicePkg/FmpDxe/FmpDxe.inf {
    <Defines>
      ...
      #
      FILE_GUID = $(FMP_CLIENT_PLATFORM_SYSTEM_TCC_CONFIG)
    <PcdsFixedAtBuild>
      #
      # Unicode name string that is used to populate FMP Image Descriptor for this capsule update module
      #
      gFmpDevicePkgTokenSpaceGuid.PcdFmpDeviceImageIdName|L"ElkhartLake TCC Config Sub Region"
    ...
    <LibraryClasses>
      ...
      #
      FmpDeviceLib|$(PLATFORM_FEATURES_PATH)/CapsuleUpdate/Library/FmpDeviceLibTccConfig/FmpDeviceLibTccConfig.inf
