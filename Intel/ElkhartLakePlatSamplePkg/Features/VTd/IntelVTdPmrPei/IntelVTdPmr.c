  ...
  )
{
  ...
  Data64.Data32.High = PciSegmentRead32 ((PCI_SEGMENT_LIB_ADDRESS (SA_SEG_NUM, SA_MC_BUS, SA_MC_DEV, SA_MC_FUN, 0)) + R_SA_TOUUD + 4);
  Data64.Data32.Low  = (PciSegmentRead32 ((PCI_SEGMENT_LIB_ADDRESS (SA_SEG_NUM, SA_MC_BUS, SA_MC_DEV, SA_MC_FUN, 0)) + R_SA_TOUUD)) & (~BIT0);
  ...
  MmioWrite64 (VtdUnitBaseAddress + R_PMEN_HIGH_BASE_REG, (UINT64) BASE_4GB);
  MmioWrite64 (VtdUnitBaseAddress + R_PMEN_HIGH_LIMITE_REG, (UINT64)Data64.Data);
