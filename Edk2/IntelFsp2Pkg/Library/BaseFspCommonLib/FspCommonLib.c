...
/**
  This function gets back the FSP API second parameter passed by the bootlaoder. //CCEO-0006: RoyalParkOverrideContent

  @retval ApiParameter FSP API second parameter passed by the bootlaoder. //CCEO-0006: RoyalParkOverrideContent
**/
UINT32
EFIAPI
GetFspApiParameter2 (
