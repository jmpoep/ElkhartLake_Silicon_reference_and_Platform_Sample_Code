# @file
#  Component description file for the IceLake SiPkg DXE libraries.
#
# @copyright
#  INTEL CONFIDENTIAL
...
# FRUs
#
!include $(PLATFORM_SI_PACKAGE)/Fru/IclCpu/DxeLib.dsc
!include $(PLATFORM_SI_PACKAGE)/Fru/IclPch/DxeLib.dsc
...
# TBT
#
 DxeTbtPolicyLib|$(PLATFORM_SI_PACKAGE)/IpBlock/Tbt/Library/DxeTbtPolicyLib/DxeTbtPolicyLib.inf
