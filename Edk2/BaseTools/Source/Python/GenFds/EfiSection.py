...
class EfiSection (EfiSectionClassObject):
    ...
    def GenSection(self, OutputPath, ModuleName, SecNum, KeyStringList, FfsInf = None, Dict = {}, IsMakefile = False) :
        ...
        if Filename is not None:
            ...
            FileList, IsSect = Section.Section.GetFileList(FfsInf, self.FileType, self.FileExtension, Dict, IsMakefile=IsMakefile, SectionType=SectionType) # CCEO-0021: RoyalParkOverrideContent
            if IsSect :
