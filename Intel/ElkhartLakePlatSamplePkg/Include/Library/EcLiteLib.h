/** @file
  EcLite library functions and definitions.

  This library provides basic EcLite interface.
...
#ifndef _BASE_ECLITE_LIB_H_
#define _BASE_ECLITE_LIB_H_
...
/**
  ...
  @param[in] Data             Data buffer to be sent/updated based on the datalength
