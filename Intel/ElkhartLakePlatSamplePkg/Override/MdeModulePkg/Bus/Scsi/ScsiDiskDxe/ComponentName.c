  ...
  )
{
  ...
  EFI_DISK_INFO_PROTOCOL  *DiskInfo;  // RPPO-LKF-0019: RoyalParkOverride
  ...
  Status = gBS->OpenProtocol (
                  ControllerHandle,
                  &gEfiDiskInfoProtocolGuid,  // RPPO-LKF-0019: RoyalParkOverride
                  (VOID **) &DiskInfo,        // RPPO-LKF-0019: RoyalParkOverride
                  gScsiDiskDriverBinding.DriverBindingHandle,
                  ControllerHandle,
  ...
  ScsiDiskDevice = SCSI_DISK_DEV_FROM_DISKINFO (DiskInfo);  // RPPO-LKF-0019: RoyalParkOverride
