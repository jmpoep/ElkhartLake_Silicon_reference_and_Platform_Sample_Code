...
#include <Protocol/UfsDeviceConfig.h>                  // RPPO-LKF-0023: Override
...
typedef struct _UFS_PASS_THRU_PRIVATE_DATA {
  ...
  EFI_UFS_DEVICE_CONFIG_PROTOCOL      UfsDevConfig;                   // RPPO-LKF-0023: Override
  EDKII_UFS_HOST_CONTROLLER_PROTOCOL  *UfsHostController;
  UINTN                               UfsHcBase;
  //
  // RPPO-LKF-0007: OverrideBegin
  //
  BOOLEAN                             UfsHcEnabledByPlatform;
  //
