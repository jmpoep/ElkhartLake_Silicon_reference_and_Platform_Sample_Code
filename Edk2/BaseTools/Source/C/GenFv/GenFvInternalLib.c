...
--*/
{
  ...
  //
//
// CCEO-0012: RoyalParkOverrideBegin
//
...
//
// CCEO-0012: RoyalParkOverrideEnd
//
  ...
  if (MachineType == EFI_IMAGE_MACHINE_IA64) {
    ...
    *SecCoreEntryAddressPtr = SecCorePhysicalAddress;
    ...
    if (PeiCorePhysicalAddress != 0) { // CCEO-0012: RoyalParkOverrideContent
      //
    ...
    }  // CCEO-0012: RoyalParkOverrideContent
    //
