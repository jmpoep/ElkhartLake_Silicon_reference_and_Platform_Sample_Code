...
import subprocess
# CCEO-0015: RoyalParkOverrideContentBegin
import tempfile
# CCEO-0015: RoyalParkOverrideContentEnd
...
def SaveFileOnChange(File, Content, IsBinaryFile=True):
    ...
    if GlobalData.gIsWindows and not os.path.exists(File):
        ...
        with tempfile.NamedTemporaryFile('wb', dir=os.path.dirname(File), delete=False) as tf:
            tf.write(Content)
            tempname = tf.name
        try:
