...
//
// This platform driver knows there are multi FVs on FD,
...
UINTN mPlatformFvBaseAddressCount = ARRAY_SIZE (mPlatformFvBaseAddress);
...
UINTN mPlatformDefaultBaseAddressCount = ARRAY_SIZE (mPlatformDefaultBaseAddress);
