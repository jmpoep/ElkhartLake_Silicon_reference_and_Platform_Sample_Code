...
Scope(\_SB)
{
  ...
  Device(STG1)  // Storage Participant
  {
    ...
    {
      If (LEqual(\SAT1,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
    ...
    {
      If (LEqual(\SPT1,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
    ...
    {
      If (LEqual(\SCT1,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
    ...
    {
      If (LEqual(\SC31,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
    ...
    {
      If (LEqual(\SHT1,0)) {Return(0xFFFFFFFF)} // Indicate DPTF driver to disable trip point
  ...
  } // End Device STG1(Storage Participant)
}// end Scope(\_SB)
