...
//
// RPPO-LKF-0005: RoyalParkOverrideBegin
//
  DEBUG ((EFI_D_INFO,"UfsEnableHostController\n"));
  Address = Private->UfsHcBase + UFS_HC_STATUS_OFFSET;
  Data = MmioRead32 (Address);
  if ((Data & UFS_HC_HCS_DP) == 1) {
    DEBUG ((EFI_D_INFO,"UFS HCS.DP already set, skip host controller initialization.\n"));
    return EFI_SUCCESS;
  }
//
// RPPO-LKF-0005: RoyalParkOverrideEnd
//
...
//
  ...
  DEBUG ((EFI_D_INFO,"UfsDeviceDetection\n"));
  Address = Private->UfsHcBase + UFS_HC_STATUS_OFFSET;
  Data = MmioRead32 (Address);
  if ((Data & UFS_HC_HCS_DP) == 1) {
    DEBUG ((EFI_D_INFO,"UFS HCS.DP already set, skip device detection.\n"));
    return EFI_SUCCESS;
  }
//
// RPPO-LKF-0005: RoyalParkOverrideEnd
