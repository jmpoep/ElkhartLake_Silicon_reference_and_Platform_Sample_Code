...
class MetaFileParser(object):
    ...
    def _Done(self):
        self._Finished = True
#        ## Do not set end flag when processing included files    # CCEO-0018: RoyalParkOverrideContent
#        if self._From == -1:                                     # CCEO-0018: RoyalParkOverrideContent
...
#
    ...
    def _PostProcess(self):
        ...
        self._Table = MetaFileStorage(self._RawTable.DB, self.MetaFile, MODEL_FILE_DSC, True)   # CCEO-0018: RoyalParkOverrideContent
        self._DirectiveStack = []
        self._DirectiveEvalStack = []
    ...
    def __ProcessDirective(self):
        ...
        if self._ItemType in [MODEL_META_DATA_CONDITIONAL_STATEMENT_IF,
            ...
            IncludedFileTable = MetaFileStorage(self._RawTable.DB, IncludedFile1, MODEL_FILE_DSC, False, FromItem=FromItem) # CCEO-0018: RoyalParkOverrideContent
            ...
            Parser.StartParse()                # CCEO-0018: RoyalParkOverrideContent
