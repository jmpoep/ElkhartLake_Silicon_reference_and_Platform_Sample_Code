...
/**
  This function gets back the FSP API first parameter passed by the bootloader. //CCEO-0006: RoyalParkOverrideContent

  @retval ApiParameter FSP API first parameter passed by the bootloader. //CCEO-0006: RoyalParkOverrideContent
**/
UINT32
EFIAPI
GetFspApiParameter (
...
/**
  This function gets back the FSP API second parameter passed by the bootloader. //CCEO-0006: RoyalParkOverrideContent

  @retval ApiParameter FSP API second parameter passed by the bootloader. //CCEO-0006: RoyalParkOverrideContent
**/
UINT32
EFIAPI
GetFspApiParameter2 (
...
//
// CCEO-0006: RoyalParkOverrideBegin
//

/**
  This function returns the FSP entry stack pointer from tha address of the first API parameter
...
//
// CCEO-0006: RoyalParkOverrideEnd
//
/**
