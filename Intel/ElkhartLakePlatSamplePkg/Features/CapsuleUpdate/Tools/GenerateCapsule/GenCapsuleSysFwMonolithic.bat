@REM
@REM Usage:
@REM   GenCapsuleSysFwMonolithic.bat [FMP Payload] [BIOS Version] [Output Path]
...
set FMP_CAPSULE_GUID=7FEB1D5D-33F4-48D3-BD11-C4B36B6D0E57
set FMP_CAPSULE_FILE=EhlSystemFwMono_%BIOS_VERSION_DEC%.Cap
set FMP_CAPSULE_VERSION=%BIOS_VERSION_HEX%
set FMP_CAPSULE_STRING=0.0.%BIOS_VERSION_DEC:~-6,-2%.%BIOS_VERSION_DEC:~-2%
set FMP_CAPSULE_NAME="Intel EHL SYSTEM FIRMWARE %FMP_CAPSULE_STRING%"
set FMP_CAPSULE_LSV=0x00000000
set WINDOWS_CAPSULE_KEY=SAMPLE_DEVELOPMENT.pfx
set WINDOWS_CAPSULE_OUTPUT_DIR=%FMP_CAPSULE_OUTPUT_DIR%\WindowsCapsule\Monolithic
