/** @file
  IPU policy definitions (PreMem) Version 2
  Version 2 supports TigerLake
...
typedef struct {
  ...
  **/
  ...
  /**
   <b>(Test)</b> If this Bit is enabled it will enable FUSA feature.
   <b>0=Disable FUSA features</b>;
   1=Enable FUSA features.
   **/
  UINT8                IpuFusaConfigEnable;
  /**
