/** @file
  Serial IO I2C Private Lib implementation ElkhartLake specific.
...
GLOBAL_REMOVE_IF_UNREFERENCED SERIAL_IO_BDF_NUMBERS mPchLpSerialIoI2cBdf [] = {
...
GLOBAL_REMOVE_IF_UNREFERENCED UINT16 mPchLpSerialIoI2cDevId [] = {
  V_VER3_SERIAL_IO_CFG_I2C0_DEVICE_ID,
  V_VER3_SERIAL_IO_CFG_I2C1_DEVICE_ID,
  V_VER3_SERIAL_IO_CFG_I2C2_DEVICE_ID,
  V_VER3_SERIAL_IO_CFG_I2C3_DEVICE_ID,
  V_VER3_SERIAL_IO_CFG_I2C4_DEVICE_ID,
  V_VER3_SERIAL_IO_CFG_I2C5_DEVICE_ID,
  V_VER3_SERIAL_IO_CFG_I2C6_DEVICE_ID,
  V_VER3_SERIAL_IO_CFG_I2C7_DEVICE_ID
};

GLOBAL_REMOVE_IF_UNREFERENCED UINT16 mPchSerialIoI2cPciCfgCtrAddr [] = {
  R_VER3_SERIAL_IO_PCR_PCICFGCTRL_I2C0,
  R_VER3_SERIAL_IO_PCR_PCICFGCTRL_I2C1,
  R_VER3_SERIAL_IO_PCR_PCICFGCTRL_I2C2,
  R_VER3_SERIAL_IO_PCR_PCICFGCTRL_I2C3,
  R_VER3_SERIAL_IO_PCR_PCICFGCTRL_I2C4,
  R_VER3_SERIAL_IO_PCR_PCICFGCTRL_I2C5,
  R_VER3_SERIAL_IO_PCR_PCICFGCTRL_I2C6,
  R_VER3_SERIAL_IO_PCR_PCICFGCTRL_I2C7
};
  ...
  )
{
  ...
  return mPchLpSerialIoI2cBdf[I2cNumber].DevNum;
}
...
{
  //@todo add other EHL PCH gen
  return mPchLpSerialIoI2cBdf[I2cNumber].FuncNum;
}
