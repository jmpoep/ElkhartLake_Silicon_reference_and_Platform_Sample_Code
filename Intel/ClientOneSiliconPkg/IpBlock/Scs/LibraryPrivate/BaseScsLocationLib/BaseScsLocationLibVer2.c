...
#include <Register/ScsVer2Regs.h>
  ...
  )
{
  switch (UfsIndex) {
    case 0:
      *DeviceNum = PCI_DEVICE_NUMBER_PCH_TGL_SCS_UFS0;
      *FunctionNum = PCI_FUNCTION_NUMBER_PCH_TGL_SCS_UFS0;
      break;
    case 1:
      *DeviceNum = PCI_DEVICE_NUMBER_PCH_TGL_SCS_UFS1;
      *FunctionNum = PCI_FUNCTION_NUMBER_PCH_TGL_SCS_UFS1;
      break;
    default:
      ASSERT (FALSE);
  }
