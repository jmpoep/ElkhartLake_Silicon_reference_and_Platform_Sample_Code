...
Scope(\_SB.IETM)
{
  ...
  {
    2,
    Package(){\_SB.PC00.TCPU,           \_SB.VIR2,                2, 300, 3182,  9, 0x00010000, "MAX", 500, 10, 20, 0},
    Package(){\_SB.PC00.TCPU,           \_SB.VIR2,                2, 300, 3382,  9, 0x00010000, "MIN", 500, 10, 20, 0},
#ifdef EC_SUPPORT
    ...
    Package(){\_SB.CHRG, \_SB.SEN3, 1, 200, 3182, 14, 0x000A0000, "MAX",   1, 10, 10, 0},
    Package(){\_SB.CHRG, \_SB.SEN3, 1, 200, 3232, 14, 0x000A0000,     1,   1, 10, 10, 0},
    Package(){\_SB.CHRG, \_SB.SEN3, 1, 200, 3282, 14, 0x000A0000,     2,   1, 10, 10, 0},
    Package(){\_SB.CHRG, \_SB.SEN3, 1, 200, 3382, 14, 0x000A0000, "MIN",   1, 10, 10, 0}
