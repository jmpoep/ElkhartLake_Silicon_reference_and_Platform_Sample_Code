## @file
#  Component description file for the ElkhartLake SiPkg DXE drivers.
#
# @copyright
#  INTEL CONFIDENTIAL
...
# FRUs
#
!include $(PLATFORM_SI_PACKAGE)/Fru/EhlCpu/Dxe.dsc
!if gSiPkgTokenSpaceGuid.PcdEhlPchEnable == TRUE
!include $(PLATFORM_SI_PACKAGE)/Fru/EhlPch/Dxe.dsc
!else
!include $(PLATFORM_SI_PACKAGE)/Fru/JslPch/Dxe.dsc
!endif

#
# Common
#
  $(PLATFORM_SI_PACKAGE)/Product/ElkhartLake/SiInit/Dxe/SiInitDxe.inf
...
!if gSiPkgTokenSpaceGuid.PcdEhlPchEnable == TRUE
  $(PLATFORM_SI_PACKAGE)/Pch/PchInit/Dxe/PchInitDxeEhl.inf
!else
...
#
  ...
  $(PLATFORM_SI_PACKAGE)/SystemAgent/SaInit/Dxe/SaInitDxeEhl.inf
