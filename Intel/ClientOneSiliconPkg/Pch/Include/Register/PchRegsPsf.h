...
#define B_PCH_PSF_PCR_GLOBAL_CONFIG_ENEEI               BIT7
#define B_PCH_PSF_PCR_GLOBAL_CONFIG_ENTCG               BIT4
#define B_PCH_PSF_PCR_GLOBAL_CONFIG_ENLCG               BIT3
#define B_PCH_PSF_PCR_GLOBAL_CONFIG_IDLENAK             BIT2
...
#define B_PCH_PSF_PCR_PORT_CONFIG_EGRESS_FRO            BIT2
#define B_PCH_PSF_PCR_PORT_CONFIG_INGRESS_FRO           BIT1
