...
#include <Register/IshRegsVer1.h>
...
{
  switch (DevId) {
    case (V_ICL_LP_ISH_DEVICE_ID) :
    case (V_ICL_H_ISH_DEVICE_ID) :
      return TRUE;
      break;
    default:
      break;
...
{
  return PCI_DEVICE_NUMBER_ICL_PCH_ISH;
}
...
{
  return PCI_FUNCTION_NUMBER_ICL_PCH_ISH;
}
