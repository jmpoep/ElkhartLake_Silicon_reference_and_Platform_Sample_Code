...
GLOBAL_REMOVE_IF_UNREFERENCED GPIO_GROUP_TO_GPE_MAPPING mPchLpGpioGroupToGpeMapping[] = {
  {GPIO_ICL_LP_GROUP_GPP_A, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_A, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_A},
  {GPIO_ICL_LP_GROUP_GPP_B, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_B, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_B},
  {GPIO_ICL_LP_GROUP_GPP_C, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_C, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_C},
  {GPIO_ICL_LP_GROUP_GPP_D, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_D, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_D},
  {GPIO_ICL_LP_GROUP_GPP_E, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_E, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_E},
  {GPIO_ICL_LP_GROUP_GPP_F, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_F, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_F},
  {GPIO_ICL_LP_GROUP_GPP_G, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_G, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_G},
  {GPIO_ICL_LP_GROUP_GPP_H, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_H, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_H},
  {GPIO_ICL_LP_GROUP_GPP_R, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_R, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_R},
  {GPIO_ICL_LP_GROUP_GPP_S, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPP_S, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPP_S},
  {GPIO_ICL_LP_GROUP_GPD,   0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_GPD,   V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_GPD},
  {GPIO_ICL_LP_GROUP_VGPIO, 0,V_ICL_PCH_LP_PMC_PWRM_GPIO_CFG_VGPIO, V_ICL_PCH_LP_GPIO_PCR_MISCCFG_GPE0_VGPIO}
};

GLOBAL_REMOVE_IF_UNREFERENCED GPIO_GROUP_TO_GPE_MAPPING mPchNGpioGroupToGpeMapping[] = {
  {GPIO_ICL_N_GROUP_GPP_A, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_A,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_A},
  {GPIO_ICL_N_GROUP_GPP_B, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_B,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_B},
  {GPIO_ICL_N_GROUP_GPP_C, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_C,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_C},
  {GPIO_ICL_N_GROUP_GPP_D, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_D,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_D},
  {GPIO_ICL_N_GROUP_GPP_E, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_E,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_E},
  {GPIO_ICL_N_GROUP_GPP_G, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_G,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_G},
  {GPIO_ICL_N_GROUP_GPP_H, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_H,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_H},
  {GPIO_ICL_N_GROUP_GPP_R, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_R,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_R},
  {GPIO_ICL_N_GROUP_GPP_S, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPP_S,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPP_S},
  {GPIO_ICL_N_GROUP_GPD,   0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_GPD,    V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_GPD},
  {GPIO_ICL_N_GROUP_VGPIO, 0,V_ICL_PCH_N_PMC_PWRM_GPIO_CFG_VGPIO,  V_ICL_PCH_N_GPIO_PCR_MISCCFG_GPE0_VGPIO}
};

GLOBAL_REMOVE_IF_UNREFERENCED GPIO_GROUP_TO_GPE_MAPPING mPchHGpioGroupToGpeMapping[] = {
  {GPIO_ICL_H_GROUP_GPP_A, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_A,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_A},
  {GPIO_ICL_H_GROUP_GPP_B, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_B,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_B},
  {GPIO_ICL_H_GROUP_GPP_C, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_C,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_C},
  {GPIO_ICL_H_GROUP_GPP_D, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_D,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_D},
  {GPIO_ICL_H_GROUP_GPP_E, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_E,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_E},
  {GPIO_ICL_H_GROUP_GPP_F, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_F,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_F},
  {GPIO_ICL_H_GROUP_GPP_G, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_G,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_G},
  {GPIO_ICL_H_GROUP_GPP_H, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_H,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_H},
  {GPIO_ICL_H_GROUP_GPP_I, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_I,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_I},
  {GPIO_ICL_H_GROUP_GPP_J, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_J,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_J},
  {GPIO_ICL_H_GROUP_GPP_K, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_K,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_K},
  {GPIO_ICL_H_GROUP_GPP_R, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_R,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_R},
  {GPIO_ICL_H_GROUP_GPP_S, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_S,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPP_S},
  {GPIO_ICL_H_GROUP_GPD,   0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPD,    V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_GPD},
  {GPIO_ICL_H_GROUP_VGPIO, 0,V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_VGPIO,  V_ICL_PCH_H_GPIO_PCR_MISCCFG_GPE0_VGPIO}
};
