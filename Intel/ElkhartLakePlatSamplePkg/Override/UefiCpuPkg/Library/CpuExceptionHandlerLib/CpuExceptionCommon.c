...
//
CONST UINT32 mErrorCodeFlag = 0x00227d00; // CCEO-0016: RoyalParkOverrideContent
...
CONST CHAR8 *mExceptionNameStr[] = {
  ...
  "#VE - Virtualization", // CCEO-0016: RoyalParkOverrideContent
  "#CP - Control Protection" // CCEO-0016: RoyalParkOverrideContent
};
