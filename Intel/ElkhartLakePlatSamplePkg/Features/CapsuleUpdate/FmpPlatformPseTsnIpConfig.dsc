## @file
# FmpDxe driver for Pse Tsn Ip Config update.
#
#@copyright
#  INTEL CONFIDENTIAL
...
##
  ...
  FmpDevicePkg/FmpDxe/FmpDxe.inf {
    <Defines>
      ...
      #
      FILE_GUID = $(FMP_CLIENT_PLATFORM_SYSTEM_PSE_TSN_IP_CONFIG)
    <PcdsFixedAtBuild>
      #
      # Unicode name string that is used to populate FMP Image Descriptor for this capsule update module
      #
      gFmpDevicePkgTokenSpaceGuid.PcdFmpDeviceImageIdName|L"ElkhartLake Pse Tsn Ip Config Sub Region"
    ...
    <LibraryClasses>
      ...
      #
      FmpDeviceLib|$(PLATFORM_FEATURES_PATH)/CapsuleUpdate/Library/FmpDeviceLibPseTsnIpConfig/FmpDeviceLibPseTsnIpConfig.inf
