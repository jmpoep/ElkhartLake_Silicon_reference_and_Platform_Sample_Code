...
//
      ...
      Field (TNVS, AnyAcc, NoLock, Preserve)
      {
        ...
        SMIC,   8   //   Software SMI completion flag  // RPPO-LKF-0021: RoyalParkOverrideContent
      }
      ...
      Method (PTS, 1, Serialized)
      {
        ...
        If (LAnd (LLess (Arg0, 6), LGreater (Arg0, 3)))
        {
          ...
          If (LNot (And (MORD, 0x10)))
          {
            ...
            Store (0x0, SMIC) // RPPO-LKF-0021: RoyalParkOverrideContent
      ...
      Method (TPPI, 3, Serialized, 0, {BuffObj, PkgObj, IntObj, StrObj}, {UnknownObj, UnknownObj, UnknownObj}) // IntObj, IntObj, PkgObj
      {
        ...
        Switch (ToInteger(Arg1))
        {
          ...
          Case (2)
          {
            ...
            Store (0, SMIC) // RPPO-LKF-0021: RoyalParkOverrideContent
