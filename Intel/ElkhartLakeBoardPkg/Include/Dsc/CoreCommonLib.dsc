...
!if gSiPkgTokenSpaceGuid.PcdEdk2MasterEnable == TRUE
  UefiBootManagerLib|$(PLATFORM_FULL_PACKAGE)/Override/MdeModulePkg/Library/UefiBootManagerLib201905/UefiBootManagerLib.inf
!else
  UefiBootManagerLib|$(PLATFORM_FULL_PACKAGE)/Override/MdeModulePkg/Library/UefiBootManagerLib/UefiBootManagerLib.inf
!endif
