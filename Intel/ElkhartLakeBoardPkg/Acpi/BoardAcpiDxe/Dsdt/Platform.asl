...
External(\_SB.PCI0.TRP0, DeviceObj)
External(\_SB.PCI0.TRP1, DeviceObj)
External(\_SB.PCI0.TRP2, DeviceObj)
External(\_SB.PCI0.TRP3, DeviceObj)
External(\_SB.PCI0.TRP4, DeviceObj)
External(\_SB.PCI0.TRP5, DeviceObj)
External(\_SB.PCI1, DeviceObj)
External(\_SB.PCI1.TRP0, DeviceObj)
External(\_SB.PCI1.TRP1, DeviceObj)
External(\_SB.PCI1.TRP2, DeviceObj)
External(\_SB.PCI1.TRP3, DeviceObj)
External(\_SB.PCI1.TRP4, DeviceObj)
External(\_SB.PCI1.TRP5, DeviceObj)
External(\_SB.PCI0.TRP0.HPSX, IntObj)
External(\_SB.PCI0.TRP1.HPSX, IntObj)
External(\_SB.PCI0.TRP2.HPSX, IntObj)
External(\_SB.PCI0.TRP3.HPSX, IntObj)
External(\_SB.PCI0.TRP4.HPSX, IntObj)
External(\_SB.PCI0.TRP5.HPSX, IntObj)
External(\_SB.PCI0.TRP0.HPEX, IntObj)
External(\_SB.PCI0.TRP1.HPEX, IntObj)
External(\_SB.PCI0.TRP2.HPEX, IntObj)
External(\_SB.PCI0.TRP3.HPEX, IntObj)
External(\_SB.PCI0.TRP4.HPEX, IntObj)
External(\_SB.PCI0.TRP5.HPEX, IntObj)
External(\_SB.PCI0.TRP0.PMEX, IntObj)
External(\_SB.PCI0.TRP1.PMEX, IntObj)
External(\_SB.PCI0.TRP2.PMEX, IntObj)
External(\_SB.PCI0.TRP3.PMEX, IntObj)
External(\_SB.PCI0.TRP4.PMEX, IntObj)
External(\_SB.PCI0.TRP5.PMEX, IntObj)
External(\_SB.PCI0.TRP0.PMSX, IntObj)
External(\_SB.PCI0.TRP1.PMSX, IntObj)
External(\_SB.PCI0.TRP2.PMSX, IntObj)
External(\_SB.PCI0.TRP3.PMSX, IntObj)
External(\_SB.PCI0.TRP4.PMSX, IntObj)
External(\_SB.PCI0.TRP5.PMSX, IntObj)
External(\_SB.PCI1.TRP0.HPSX, IntObj)
External(\_SB.PCI1.TRP1.HPSX, IntObj)
External(\_SB.PCI1.TRP2.HPSX, IntObj)
External(\_SB.PCI1.TRP3.HPSX, IntObj)
External(\_SB.PCI1.TRP4.HPSX, IntObj)
External(\_SB.PCI1.TRP5.HPSX, IntObj)
External(\_SB.PCI1.TRP0.HPEX, IntObj)
External(\_SB.PCI1.TRP1.HPEX, IntObj)
External(\_SB.PCI1.TRP2.HPEX, IntObj)
External(\_SB.PCI1.TRP3.HPEX, IntObj)
External(\_SB.PCI1.TRP4.HPEX, IntObj)
External(\_SB.PCI1.TRP5.HPEX, IntObj)
External(\_SB.PCI1.TRP0.PMEX, IntObj)
External(\_SB.PCI1.TRP1.PMEX, IntObj)
External(\_SB.PCI1.TRP2.PMEX, IntObj)
External(\_SB.PCI1.TRP3.PMEX, IntObj)
External(\_SB.PCI1.TRP4.PMEX, IntObj)
External(\_SB.PCI1.TRP5.PMEX, IntObj)
External(\_SB.PCI1.TRP0.PMSX, IntObj)
External(\_SB.PCI1.TRP1.PMSX, IntObj)
External(\_SB.PCI1.TRP2.PMSX, IntObj)
External(\_SB.PCI1.TRP3.PMSX, IntObj)
External(\_SB.PCI1.TRP4.PMSX, IntObj)
External(\_SB.PCI1.TRP5.PMSX, IntObj)
...
Scope(\_SB.PCI0)
{
  ...
  Method(_INI,0, Serialized)
  {
    ...
    {
      //
      // ITBT Implementation guide 0.7
      // Section 2.2.2.1 The _INI and _WAK methods shall execute OS_UP mailbox command
      //
      Acquire(OSUM, 0xFFFF)
      If(LEqual(IDM0, 0x01))
      {
...
Scope (\)
{
  Method(NHPG,0,Serialized)
  {
    ...
    Store(0,\_SB.PCI0.TRP0.HPEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP1.HPEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP2.HPEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP3.HPEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP4.HPEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP5.HPEX) // clear the hot plug SCI enable bit
    If (CondRefOf(\_SB.PCI1)) {
      Store(0,\_SB.PCI1.TRP0.HPEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP1.HPEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP2.HPEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP3.HPEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP4.HPEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP5.HPEX) // clear the hot plug SCI enable bit
    }
    ...
    Store(1,\_SB.PCI0.TRP0.HPSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP1.HPSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP2.HPSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP3.HPSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP4.HPSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP5.HPSX) // clear the hot plug SCI enable bit
    If (CondRefOf(\_SB.PCI1)) {
      Store(1,\_SB.PCI1.TRP0.HPSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP1.HPSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP2.HPSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP3.HPSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP4.HPSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP5.HPSX) // clear the hot plug SCI enable bit
    }
  }
  ...
  Method(NPME,0,Serialized)
  {
    ...
    Store(0,\_SB.PCI0.TRP0.PMEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP1.PMEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP2.PMEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP3.PMEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP4.PMEX) // clear the hot plug SCI enable bit
    Store(0,\_SB.PCI0.TRP5.PMEX) // clear the hot plug SCI enable bit
    If (CondRefOf(\_SB.PCI1)) {
      Store(0,\_SB.PCI1.TRP0.PMEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP1.PMEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP2.PMEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP3.PMEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP4.PMEX) // clear the hot plug SCI enable bit
      Store(0,\_SB.PCI1.TRP5.PMEX) // clear the hot plug SCI enable bit
    }
    ...
    Store(1,\_SB.PCI0.TRP0.PMSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP1.PMSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP2.PMSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP3.PMSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP4.PMSX) // clear the hot plug SCI enable bit
    Store(1,\_SB.PCI0.TRP5.PMSX) // clear the hot plug SCI enable bit
    If (CondRefOf(\_SB.PCI1)) {
      Store(1,\_SB.PCI1.TRP0.PMSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP1.PMSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP2.PMSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP3.PMSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP4.PMSX) // clear the hot plug SCI enable bit
      Store(1,\_SB.PCI1.TRP5.PMSX) // clear the hot plug SCI enable bit
    }
  }
  //
