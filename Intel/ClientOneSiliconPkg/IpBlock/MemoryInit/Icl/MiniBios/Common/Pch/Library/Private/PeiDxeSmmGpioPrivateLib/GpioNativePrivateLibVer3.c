  ...
  )
{
  if (IsPchLp ()) {
    switch (PadFunction) {
      ...
      case GPIO_FUNCTION_PSE_I2S_RX(0):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_E15, 1, PadFunction);
      case GPIO_FUNCTION_PSE_I2S_RX(1):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_F19, 1, PadFunction);
      case GPIO_FUNCTION_PSE_I2S_TX(0):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_E16, 1, PadFunction);
      case GPIO_FUNCTION_PSE_I2S_TX(1):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_F18, 1, PadFunction);
      case GPIO_FUNCTION_PSE_I2S_CLK(0):          return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_E20, 1, PadFunction);
      case GPIO_FUNCTION_PSE_I2S_CLK(1):          return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_F7,  1, PadFunction);
      case GPIO_FUNCTION_PSE_I2S_SFRM(0):         return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_E21, 1, PadFunction);
      ...
      case GPIO_FUNCTION_PSE_PWM(8):              return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H4,  4, PadFunction);
      case GPIO_FUNCTION_PSE_PWM(9):              return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H5,  4, PadFunction);
      case GPIO_FUNCTION_PSE_PWM(10):             return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H6,  4, PadFunction);
      case GPIO_FUNCTION_PSE_PWM(11):             return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H7,  4, PadFunction);
      case GPIO_FUNCTION_PSE_PWM(12):             return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H8,  4, PadFunction);
      case GPIO_FUNCTION_PSE_PWM(13):             return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H9,  4, PadFunction);
      case GPIO_FUNCTION_PSE_PWM(14):             return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H10, 4, PadFunction);
      case GPIO_FUNCTION_PSE_PWM(15):             return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H11, 4, PadFunction);
      ...
      case GPIO_FUNCTION_PSE_SPI_MOSI(1):         return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_D3,  4, PadFunction);
      ...
      case GPIO_FUNCTION_PSE_SPI_MISO(1):         return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_D2,  4, PadFunction);
      ...
      case GPIO_FUNCTION_PSE_SPI_CLK(1):          return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_D1,  4, PadFunction);
      ...
      case GPIO_FUNCTION_PSE_SPI_CS (1, 0):       return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_D0,  4, PadFunction);
      ...
      case GPIO_FUNCTION_PSE_TGPIO(6):            return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_G13, 1, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(7):            return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_G14, 1, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(8):            return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_G15, 1, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(9):            return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_G16, 1, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(10):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_D9,  8, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(11):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_D10, 8, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(12):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_D11, 8, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(13):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_D12, 8, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(14):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_G21, 1, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(15):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_G22, 1, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(16):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_E7,  8, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(17):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_V13, 1, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(18):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_V14, 1, PadFunction);
      case GPIO_FUNCTION_PSE_TGPIO(19):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_V15, 1, PadFunction);
      ...
      case GPIO_FUNCTION_DDSP_HPD('C'):           return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_E17, 1, PadFunction);
      case GPIO_FUNCTION_DDSP_HPD(1):             return GPIO_NATIVE_PAD_DEF (GPIO_VER3_GPP_H20, 2, PadFunction);
...
{
  {// DDPA
    {GPIO_VER3_GPP_H16, GpioPadModeNative1},// DDPA_CTRLCLK
    {GPIO_VER3_GPP_H19, GpioPadModeNative1} // DDPA_CTRLDATA
  },
  {// DDPB
  ...
  {// DDPC
    {GPIO_VER3_GPP_E23, GpioPadModeNative1},// DDPC_CTRLCLK
    {GPIO_VER3_GPP_E22, GpioPadModeNative1} // DDPC_CTRLDATA
  }
};
...
//
// Pse Tsn pins for PSE TSN0 or PSE TSN1
//
