...
EDKII_SMM_VARIABLE_PROTOCOL   *mEdkiiSmmVariable; // RPPO-LKF-0021: RoyalParkOverrideContent
...
//
// ROYAL_PARK_OVERRIDE: RoyalParkOverrideBegin RPPO-LKF-0021
//
...
VOID
EFIAPI
MemoryOverwriteRequestSetVariableCallback (
  ...
  )
{
  ...
  //
  // RPCO-0101 override begin
  //
  else {
    mTcgNvs->MemoryClear.ReturnCode = MOR_REQUEST_GENERAL_FAILURE;
    DEBUG((EFI_D_ERROR, "[TPM] Undefined definition for TCG MOR\n"));
    return EFI_SUCCESS;
  }
  //
  // RPCO-0101 override end
  //
  DataSize = sizeof (UINT8);
